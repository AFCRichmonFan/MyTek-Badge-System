						                ...
						                <div class="card-header" id="heading-<?php echo $badge->badge_id; ?>">
										                    <h2 class="mb-0">
															                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse-<?php echo $badge->badge_id; ?>" aria-expanded="true" aria-controls="collapse-<?php echo $badge->badge_id; ?>">
																					                            <?php echo $badge->name; if($badge->hidden == 1){echo " - (Hidden)";}; ?>
																												                        </button>
																																		                    </h2>
																																							                </div>
...
<p>Earned by <?php echo $badge->amount_earned;  ?> students</p>
<a href="<?php echo URLROOT . "pages/editBadge/" . $badge->badge_id ?>">Edit link</a>
																																																																						                    </div>
																																																																											                </div>
																																																																															            </div>
																																																																																		        <?php endforeach; ?>
...
<p>
<br>
<a href="<?php echo URLROOT . "pages/viewBadges/$limit/0/$category/$order"; ?>">First</a>
<a href="<?php echo URLROOT . "pages/viewBadges/$limit/".($offset - 10) ."/$category/$order"; ?>">Previous</a>
<a href="<?php echo URLROOT . "pages/viewBadges/$limit/".($offset + 10) ."/$category/$order"; ?>">Next</a>
<a href="<?php echo URLROOT . "pages/viewBadges/$limit/$last/$category/$order"; ?>">Last</a>
</p>																																																																																					
